...
export const COMMON_GET_ALL_USER_INFO =
  'http://47.96.112.31:8086/jeecg-boot/intf/location/getAllDeptPeople';

/**
 * 获取所有地图
 */
export const COMMON_GET_ALL_MAP = 'http://47.96.112.31:8086/jeecg-boot/intf/location/getAllMap';
...
export const COMMON_GET_ALL_FENCING_TYPES =
  'http://47.96.112.31:8086/jeecg-boot/intf/location/getAllFenceType';

/**
 * 获取所有区域
 */
export const COMMON_GET_ALL_AREAS =
  'http://47.96.112.31:8086/jeecg-boot/intf/location/getAllRegion';

/**
 *  职务信息列表
 */
export const COMMON_GET_ALL_DUTIES =
  'http://47.96.112.31:8086/jeecg-boot/intf/location/queryPositionList';
