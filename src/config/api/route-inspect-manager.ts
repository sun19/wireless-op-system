...
// 查询
export const INSPECT_MANAGER_SEARCH =
...
export const INSPECT_MANAGER_LIST_SEARCH =
  'http://47.95.195.189:8086/jeecg-boot/intf/location/listReportIntf';
// 导出
export const INSPECT_MANAGER_LIST_EXPORT =
  'http://47.95.195.189:8086/jeecg-boot/intf/location/exportXlsInspectionReport';
