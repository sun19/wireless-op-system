...
class SuperAdmin extends React.Component<Props, State> {
  ...
  async getInfoListData() {
    ...
    const onlineStatus = this.state.onlineState;
    const { userName, name, type } = this.state;

    const infoList = await getInfoListParams({ userName, name, type, isCancel, onlineStatus });
    ...
    return (
      <div style={{ marginTop: '-3px' }}>
        <Select
          ...
          placeholder="请选择是否在线"
          className={publicStyles.select_text}
          onChange={this.selectOnlineStateChange}
      ...
      <div className={publicStyles.public_hight}>
        <Content className={publicStyles.bg}>
          <div className={styles.public_hight_40}>
            <Form layout="inline">
              <Row justify="start" align="middle" style={{ paddingLeft: '39px' }} gutter={8}>
                <FormItem label="姓名">
                  <Input
                ...
                <FormItem label="是否在线">{this.setupOnliineState()}</FormItem>
