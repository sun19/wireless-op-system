...
class EditSuperAdmin extends React.Component<Props, State> {
  ...
  goBack = () => {
    ...
    // router.push('/system-setting/department-count/edit');
  };
...
dic["id"] = superAdminRecord.id
      ...
      if (isSuccessed) {
        setTimeout(() => router.push('/system-setting/department-count'), 1000);
      }
    });
  }
            ...
            <Col span={12}>
              <div className="auth__inner--container">
                <Row type="flex" justify="space-between">
                  <Col span={12}>
                    <Form.Item label="部门数量">
                      {getFieldDecorator('dictName', {
                        rules: [],
                        initialValue: superAdminRecord.dictName,
                      })(<Input placeholder="请输入部门数量" />)}
                    </Form.Item>
                  </Col>
                </Row>
