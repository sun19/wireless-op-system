...
class UserAuths extends React.Component<Props, State> {
  ...
  connectWs() {
    ...
    this.ws.onopen = () => {
      request.get(
        'http://139.129.229.99:8086/jeecg-boot/intf/location/executeUserCard?status=true',
      );
    };
    ...
    this.ws.onclose = () => {
      request.get(
        'http://139.129.229.99:8086/jeecg-boot/intf/location/executeUserCard?status=false',
      );
    };
  }
